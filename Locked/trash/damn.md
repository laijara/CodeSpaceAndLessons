...
![Запуск командной строки](cmd_start.png) *(замените имя файла на ваш скриншот)*
...
dir
```
![Навигация по папкам](cmd_nav.png) *(замените имя файла на ваш скриншот)*
...
```
![Управление Блокнотом](notepad_task.png) *(замените имя файла на ваш скриншот)*
...
```
![Запуск WordPad](wordpad_task.png) *(замените имя файла на ваш скриншот)*
...
```
![Отслеживание explorer.exe](explorer_track.png) *(замените имя файла на ваш скриншот)*
...
![Перезапуск Проводника в Диспетчере задач](explorer_taskmgr.png) *(замените имя файла на ваш скриншот)*
...
start explorer.exe
```
![Перезапуск Проводника в CMD](explorer_cmd.png) *(замените имя файла на ваш скриншот)*
